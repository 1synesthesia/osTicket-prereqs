...
<h2>List of Prerequisites for Azure VM</h2>
...
<h2>Configuring and Accessing your Azure VM</h2>
...
<p>
<img width="1143" height="800" alt="Screenshot 2026-06-24 232635" src="https://github.com/user-attachments/assets/a9b08120-aab0-4469-8046-7b4461bd080d" />
</p>
<p>
...
<p>
<img width="793" height="722" alt="Screenshot 2026-06-24 232939" src="https://github.com/user-attachments/assets/458c0812-526d-4527-87ce-66193be58c00" />
<img width="857" height="734" alt="Screenshot 2026-06-24 232953" src="https://github.com/user-attachments/assets/4884574f-be53-45fa-bf06-72d0b5dfc2a8" />
</p>
<p>
- The most important part of setting up your Azure VM for osTicket is to make sure you select Windows 11 Pro. 

- You will also be setting your username and password on this screen. 

- While selecting the size of your VM it is important to consider how many users you think will be accessing the osTicket system. For this tutorial only 2 vcpus will be selected but be sure to increase your size based on necessity.

- The last step is to check the box asking if you have an eligible Windows 11 license.

- Note: If you are using this tutorial to set up osTicket for you business make sure to have your RDP ports limited to IP addresses specific to your business.
</p>
<br />

<p>
<img width="732" height="1163" alt="Screenshot 2026-06-24 233645" src="https://github.com/user-attachments/assets/28598fb8-e1c7-469d-aa6f-4ed33bd92195" />
</p>
<p>
- After you are done with the setup you will be taken to the review and create page. If everything checks out create your Azure VM!
</p>
<br />

<p>
<img width="1977" height="37" alt="Screenshot 2026-06-24 234947" src="https://github.com/user-attachments/assets/0204480b-9235-41a1-bf02-74042d07e71d" />
</p>
<p>
- After your VM is created and deployed it should show up in your virtual machines looking something like this.
</p>
<br />

<p>
<img width="402" height="481" alt="Screenshot 2026-06-24 235121" src="https://github.com/user-attachments/assets/af3c91ac-5685-4860-bad7-20cedbbd7b63" />
</p>
<p>
- Now you will want to access your new VM. To do this open up Remote Desktop on your computer.

- Using the public IP address provided to you by your VM, your username, and password that you setup you should be able to access the new VM.
</p>
<br />
...
<p>
- Navigate to Control Panel and then select uninstall a program. Once you are there you will want to click 'Turn Windows features on or off'. 

- Then you will want to activate Internet Information Services and make sure to expand and navigate to World Wide Web services. Expand the WWWS, find Application Development Features and expand, and then check the box next to CGI (do not forget this step otherwise osTicket will not work). 
...
<p>
- Next you will want to install a <a href="https://github.com/RonaldCarter/PHPManager/releases)/">PHP Manager for IIS</a>. 
...
<p>
- Now you will simply download the <a href="https://www.iis.net/downloads/microsoft/url-rewrite">Rewrite Module</a> necessary for osTicket. 
...
<p>
- Now that you have a directory for your PHP; download the most up-to-date <a href="https://downloads.php.net/~windows/releases/archives/">PHP Scripting Language</a> available.
  
- Once you have downloaded the zip file you will want to extract all files into your PHP directory on your C: drive.
</p>
<br />

<h3>Step 6: Install the <a href="https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170&viewFallbackFrom=msvc-170%2F">C++ Redistributable</a></h3>
<p>
...
<p>
- Now you will download the latest version of <a href="https://dev.mysql.com/downloads/mysql/">mySQL installer</a> (make sure it is the MSI installer as shown above). 
  
- The first step in the installation process will be to decide what type of installation setup you would like to use; for the purposes of this tutorial you will use Typical setup.
...
- Once open navigate to PHP Manager and click 'register new PHP version'. The .exe file necessary will be found within your PHP directory on your C: drive. 
  
- After you have registered the PHP simply restart the IIS server at the home page under Actions>Manage Server. 
</p>
<br />

<h3>Step 9: Download and install <a href="https://osticket.com/download/">osTicket</a></h3>
<p>
...
<h3>Step 12: Install <a href="https://www.heidisql.com/download.php">HeidiSQL</a> and setup osTicket Database</h3>
<p>
